...
@section('content')
    ...
    <div class="form-group">
        {!! Form::label('name', trans('admin::admin.users-create-name'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::text('name', old('name'), ['class'=>'form-control', 'placeholder'=> trans('admin::admin.users-create-name_placeholder')]) !!}
        </div>
    </div>
